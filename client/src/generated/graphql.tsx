...
`;
export type OnboardUserMutationFn = ReactApollo.MutationFn<OnboardUserMutation, OnboardUserMutationVariables>;

export function useOnboardUserMutation(
  baseOptions?: ReactApolloHooks.MutationHookOptions<OnboardUserMutation, OnboardUserMutationVariables>
) {
